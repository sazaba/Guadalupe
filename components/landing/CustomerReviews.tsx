...
export default function CustomerReviews() {
  ...
  return (
    // ✅ CORRECCIÓN 1: Se eliminó el bg-[#FFFDFE] para que sea transparente y tome el color del page.tsx
    <section className="relative py-24 overflow-hidden z-10" id="reviews">
      ...
      <div className="relative w-full flex items-center justify-center">
        ...
        {/* ✅ CORRECCIÓN 2: Los gradientes ahora usan #FFF6F9 para fundirse perfectamente con el fondo de la sección */}
        <div className="absolute left-0 top-0 bottom-0 w-16 md:w-40 bg-gradient-to-r from-[#FFF6F9] to-transparent z-20 pointer-events-none" />
        <div className="absolute right-0 top-0 bottom-0 w-16 md:w-40 bg-gradient-to-l from-[#FFF6F9] to-transparent z-20 pointer-events-none" />
